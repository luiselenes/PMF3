...
class PathsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create path" do
    assert_difference('Path.count') do
      post paths_url, params: { path: { lat: @path.lat, lng: @path.lng, routes_id: @path.routes_id, sensor: @path.sensor } }
    end
  ...
  test "should update path" do
    patch path_url(@path), params: { path: { lat: @path.lat, lng: @path.lng, routes_id: @path.routes_id, sensor: @path.sensor } }
